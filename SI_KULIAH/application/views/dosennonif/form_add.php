...
<div class="crumb"> 
	<ul class="breadcrumb"> 
		...
		<li class="active">Dosen Non IF</li>
</ul> </div>
<div class="container-fluid">
	<div id="heading" class="page-header">
			<h1><i class="icon20 i-file-7"></i>Dosen Non IF</h1>
	</div>
	<div class="row-fluid">
		<div class="span12">
			<div class="widget">
											...
											<div class="tab-pane fade in" id="tab1-content">
												<div>
													...
													<div class="widget-content">
															<?php echo form_open_multipart('con_dosennonif/upload/');?>
												...
												<div>
													...
													<div class="widget-content">
														<form  action='<?php echo site_url("dosennonif/save_add")?>' method='post' id='formdosen' class='form-horizontal'>
												...
												<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-hover" id="dataTable">
													...
													<tbody>
														...
														<tr>
															...
															<td> 
																<?php echo anchor('con_dosennonif/update_data/'.$hasil->id_dosen,'Edit','class="btn btn-primary"'); ?> 
																<?php echo anchor('dosennonif/delete/'.$hasil->id_dosen,'Delete',
																array('class'=>"btn btn-danger",'onclick'=>"return confirm('apakah anda ingin menghapus data Dosen Non IF ?')"));?>
															</td>
														</tr>
														<?php
															$no++;
