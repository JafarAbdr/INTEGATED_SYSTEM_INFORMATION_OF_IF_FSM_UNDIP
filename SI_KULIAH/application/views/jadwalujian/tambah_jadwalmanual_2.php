		...
		<div class="span12">
			<div class="widget">
				<div class="widget-title">
					...
					<span class="badge badge-important"><?php echo "Waktu sudah ada didatabase"?></span>
					<?php echo $msg; ?>
																...
																<form  action='<?php echo site_url("con_jadwal_ujian/validate_tambahdata_manual")?>' method='post' id='formjadwal' class='form-horizontal'>
																	...
																	<div class='control-group'>
																		...
																		<div class='controls controls-row'>
																			<div class='span4'>   
																				<?php echo form_dropdown('thn_ajar', $dropdownYear,$inp['thn_ajar'],'class="select2" id="thn_ajar"');?>
																			</div>
																			<div id='cek_thn_ajar'>
																	...
																	<div class='control-group'>
																		...
																		<div class='controls controls-row'>
																			<div class='span3'>   
																				<?php echo form_dropdown('semester',$dropdownSemester,$inp['semester'],'class="select2" id="semester"');?>
																			</div>
																			<div id='cek_semester'>
																		...
																		<div class='controls controls-row'>
																			<div class='span3'>
																				<select name='uts_uas' id='uts_uas' class='select2' style='width:100%;' required>
																					<option></option>
																					<option value='UTS' <?php if($inp['uts_uas']==='UTS'){echo 'selected';}?>>UTS</option>
																					<option value='UAS' <?php if($inp['uts_uas']==='UAS'){echo 'selected';}?>>UAS</option>
																				</select>
																			</div>
																			<div id='cek_semester'>
																				<?php echo form_error('semester'); ?>
																		...
																		<div class='controls controls-row'>
																			<div class='span2'>   
																				<div class="input-append date" id="dp3" >
																					<input class="m-wrap m-ctrl-medium date-picker" name="tanggal" id="tanggal" size="16" type="text" placeholder="Isikan Tanggal" value="<?php echo $inp['tanggal']?>"/>
																	...
																	<div class='control-group'>
																		...
																		<div class='controls controls-row'>
																			<div class='span5'>   
																				<?php echo form_dropdown('matkul',$dropdownMatkul,$inp['pengampu'],'class="select2" id="matkul"');?>
																			</div>
																		</div>
																	</div>
																	<div class='control-group'>
																		...
																		<div class='controls controls-row'>	
																			<div class="input-append bootstrap-timepicker-component">
																				...
																				<input class="m-wrap m-ctrl-small timepicker-default" type="text" name='jammulai' id='jammulai' style="width:145px;" value="<?php echo $inp['jammulai']?>"/>
																			</div> 
																		</div>
																	</div>
																	<div class='control-group'>
																		...
																		<div class='controls controls-row'>	
																			<div class="input-append bootstrap-timepicker-component">
																				<span class="add-on"><i class="icon-time"></i></span>
																				<input class="m-wrap m-ctrl-small timepicker-default" type="text" name='jamselesai' id='jamselesai' style="width:145px;" value="<?php echo $inp['jamselesai']?>"/>
																			</div>
																		</div>
																	</div>
																	<div class='control-group'>
																		...
																		<div class='controls controls-row'>	
																			<div class='span2'>
																				<input type='text' name='peserta' id='peserta' class='required' placeholder='Jumlah Peserta' style="width:135px;" value="<?php echo $inp['peserta']?>">
																			</div>
																		</div>
																	</div>
