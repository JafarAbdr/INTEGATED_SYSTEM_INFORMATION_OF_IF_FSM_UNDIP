											...
											<div class='span12'>
														<div class='widget'>
															...
															<div class='widget-content'>
																<form  action='<?php echo site_url("jadwalujian/save_add")?>' method='post' id='formjadwal' class='form-horizontal'>
																	...
																	<div class='control-group'>
																		...
																		<div class='controls controls-row'>	
																			<div class="input-append bootstrap-timepicker-component">
																				...
																				<input class="m-wrap m-ctrl-small timepicker-default" type="text" name='jammulai' id='jammulai' value="<?php echo $inp['jammulai']; ?>" style="width:145px;"/>
																			</div> 
																		</div>
																	</div>
																	<div class='control-group'>
																		...
																		<div class='controls controls-row'>	
																			<div class="input-append bootstrap-timepicker-component">
																				<span class="add-on"><i class="icon-time"></i></span>
																				<input class="m-wrap m-ctrl-small timepicker-default" type="text" name='jamselesai' id='jamselesai' value="<?php echo $inp['jamselesai']; ?>" style="width:145px;"/>
																			</div>
																		</div>
																	</div>
																	<div class='control-group'>
																		...
																		<div class='controls controls-row'>	
																			<div class='span2'>
																				<input type='text' name='peserta' id='peserta' class='required' placeholder='Jumlah Peserta' value="<?php echo $inp['peserta']; ?>" style="width:135px;">
																			</div>
																		</div>
																	</div>
