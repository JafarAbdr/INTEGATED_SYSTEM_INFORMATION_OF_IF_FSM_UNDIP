...
<div class="crumb"> 
	<ul class="breadcrumb"> 
		...
		<li><a href="#">Dosen IF</a> <span class="divider">/</span></li> 
		<li class="active">Edit Dosen IF</li>
</ul> </div>
<div class="container-fluid">
   <div id="heading" class="page-header">
      <h1><i class="icon20 i-file-7"></i>Form Dosen IF</h1>
   </div>
   <div class="row-fluid">
	...
	<div class='span12'>
		<div class='widget'>
			...
			<div class='widget-content'>
				<form  action='<?php echo site_url("con_dosenif/save_update_data/".$hasil->id_dosen)?>' method='post' id='formdosen' class='form-horizontal'>
				...
				<div class='form-actions'>
					...
					<?php echo anchor ('dosenif/add',form_button('back','Cancel','class="btn btn-danger"'));?>
				</div>
