...
<script src="<?php echo base_url('assets/js/hitungbeban/hitungbeban.js')?>"></script>
...
<div class="crumb"> 
	<ul class="breadcrumb"> 
		<li><a href="#">Perhitungan Beban</a> <span class="divider">/</span></li> 
		<li class="active">Dosen IF</li> 
</ul> </div>
<div class="container-fluid">
   <div id="heading" class="page-header">
      <h1><i class="icon20 i-calculate-2"></i>Matriks Perhitungan Beban Mengajar</h1>
   </div>
   <div class="row-fluid">
      <div class="span12">
         ...
         <div class="widget">
            ...
            <div class="widget-content">
               <form class="form-horizontal" method="post" action="<?php echo site_url('hitungbeban/view');?>" id='formSKDekan'>
