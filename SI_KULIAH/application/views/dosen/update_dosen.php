	...
	<div class='span12'>
		<div class='widget'>
			...
			<div class='widget-content'>
				<form  action='<?php echo site_url("con_dosen/save_update_data/".$hasil->id_dosen)?>' method='post' id='formdosen' class='form-horizontal'>
				...
				<div class='form-actions'>
					...
					<?php echo anchor ('dosen/add',form_button('back','Cancel','class="btn btn-danger"'));?>
				</div>
