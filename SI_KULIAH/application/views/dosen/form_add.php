											...
											<div class="tab-pane fade in" id="tab1-content">
												<div>
													...
													<div class="widget-content">
															<?php echo form_open_multipart('con_dosen/upload/');?>
												...
												<div>
													...
													<div class="widget-content">
														<form  action='<?php echo site_url("dosen/save_add")?>' method='post' id='formdosen' class='form-horizontal'>
												...
												<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-hover" id="dataTable">
													...
													<tbody>
														...
														<tr>
															...
															<td> 
																<?php echo anchor('con_dosen/update_data/'.$hasil->id_dosen,'Edit','class="btn btn-primary"'); ?> 
