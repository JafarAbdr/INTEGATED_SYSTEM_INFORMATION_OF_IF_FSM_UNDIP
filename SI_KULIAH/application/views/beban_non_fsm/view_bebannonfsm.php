									...
									<div class="widget-content noPadding">
										<ul id="myTab" class="nav nav-tabs">
											<li class="tabmenu" id="tab1">
												<a href="#tab1-content" data-toggle="tab">Tambah Beban Mengajar</a>
											</li>
											<li class="tabmenu" id="tab2">
												<a href="#tab2-content" data-toggle="tab">Lihat Daftar Beban Mengajar</a>
											</li>
										</ul>
												...
												<form  action='<?php echo site_url("beban_non_fsm/save_add")?>' method='post' name='formbebannonfsm' id='formbebannonfsm' class='form-horizontal'>
													...
													<div class='control-group'>
														...
														<div class='controls controls-row'>
															...
															<input type='text' name='matkul' id='matkul' class='required span6' placeholder='masukan jumlah kelas'>
													...
													<tbody>
														...
														<tr>
															...
															<td> 
																...
																<?php echo anchor('con_beban_non_fsm/delete_data/'.$q[$i]['id_beban_non_fsm'],'Delete', array('class'=>"btn btn-danger",'onclick'=>"return confirm('apakah anda ingin 	menghapus data Beban Non FSM ?')"));?>
															</td>
														</tr>
														<?php
															$no++;
