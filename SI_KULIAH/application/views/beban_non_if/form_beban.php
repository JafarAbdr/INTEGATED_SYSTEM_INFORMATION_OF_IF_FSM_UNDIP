   ...
   <div class='span12'>
      <div class='widget'>
         <div class='widget-title'>
            ...
            &nbsp&nbsp
            <span class="badge badge-important"><?php if(isset($salah)){ echo "Semesterke dan pengaturan date semester bentrok";}?></span>
         ...
         <div class='widget-content'>
            ...
            <?php endif;?>
				<input type='hidden' name='semester' id='semester' class='required span12' placeholder='masukan jumlah kelas' value='<?php echo $semester;?>'>    
            <div class='control-group'>
