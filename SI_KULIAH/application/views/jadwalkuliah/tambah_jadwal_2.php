		...
		<div class="span12">
			<div class="widget">
				<div class="widget-title">
					...
					<h4>Tambah dan Tampil Jadwal</h4>
											...
											<div class='span8'>
														<div class='widget'>
															...
															<div class='widget-content'>
																<form  action='<?php echo site_url("jadwalkuliah/save_add")?>' method='post' id='formjadwal' class='form-horizontal'>
																		...
																		<div class='controls controls-row'>
																			<div class='span5'>
																				<select name='kelas[]' id='kelas' class='select2' style='width:100%;' multiple required>
																					<option></option>
																					<option value='A' <?php if(isset($inp['kelas'][0]) == 'A'){echo 'selected';};?> >A</option>
																					<option value='B' <?php if(isset($inp['kelas'][1]) == 'B'){echo 'selected';};?> >B</option>
																					<option value='C' <?php if(isset($inp['kelas'][2]) == 'C'){echo 'selected';};?>>C</option>
																				</select>
																			</div>
																		</div>
																	</div>																	
																	<div class='form-actions'>
																		...
																		<?php echo anchor ('jadwalkuliah',form_button('back','Cancel','class="btn btn-danger"'));?>
																	</div>																
																</form>
															</div>
														</div>
												...
												<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-hover" id="dataTable">
													...
													<tbody>
														...
														<tr>
															...
															<td> 
																<?php echo anchor('jadwalkuliah/edit/'.$q[$i]['id_jadwal'],'Edit','class="btn btn-primary "');?> 
																<?php echo anchor('jadwalkuliah/delete/'.$q[$i]['id_jadwal'],'Delete',
