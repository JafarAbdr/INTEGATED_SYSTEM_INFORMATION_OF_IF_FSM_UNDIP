		...
		<div class="span12">
			<div class="widget">
				...
				<div class="widget-content">
					<form  action='<?php echo site_url("jadwalkuliah/save_edit/".$id_jadwal)?>' method='post' id='formjadwal' class='form-horizontal'>
							...
							<div class='controls controls-row'>
								<div class='span3'>
									<select name='hari' id='hari' class='select2' style='width:100%;' required>
										<option></option>
										<option value='Senin' <?php if($hasil->hari == 'Senin'){echo 'selected';};?> >Senin</option>
										<option value='Selasa' <?php if($hasil->hari == 'Selasa'){echo 'selected';};?> >Selasa</option>
										<option value='Rabu' <?php if($hasil->hari == 'Rabu'){echo 'selected';};?> >Rabu</option>
										<option value='Kamis'<?php if($hasil->hari == 'Kamis'){echo 'selected';};?> >Kamis</option>
										<option value='Jumat' <?php if($hasil->hari == 'Jumat'){echo 'selected';};?>>Jumat</option>
									</select>
								</div>
							</div>
						</div>
