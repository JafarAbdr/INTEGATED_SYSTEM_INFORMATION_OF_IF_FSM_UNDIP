											...
											<div class='span8'>
														<div class='widget'>
															...
															<div class='widget-content'>
																<form  action='<?php echo site_url("con_jadwal_kuliah/validate_tambahdatamanual")?>' method='post' id='formjadwal' class='form-horizontal'>
																	<input type="hidden" id="url" name="url" value="<?php echo site_url('con_jadwal_kuliah/get_semester')?>">
