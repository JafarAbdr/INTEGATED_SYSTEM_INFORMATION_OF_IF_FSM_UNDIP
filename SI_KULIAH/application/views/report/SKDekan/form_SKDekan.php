...
<script src="<?php echo base_url('assets/js/report/SKDekan.js')?>"></script>
<!--<script src="<?php echo base_url('assets/js/pages/data-tables.js');?>"></script>-->
<div class="crumb"> 
	<ul class="breadcrumb"> 
		<li><a href="#">Report</a> <span class="divider">/</span></li> 
		<li class="active">SK Dekan</li> 
	</ul> 
</div>
<div class="container-fluid">
   <div id="heading" class="page-header">
      <h1><i class="icon20 i-file-3"></i>Surat Keputusan Dekan</h1>
   </div>
   <div class="row-fluid">
      <div class="span12">
         ...
         <div class="widget">
            ...
            <div class="widget-content">
               <form class="form-horizontal" method="post" action="<?php echo site_url('report/SKDekan_view');?>" id='formSKDekan'>
