  ...
  <div id="login">
    <div class="login-wrapper" data-active="log"><img src="" alt=""></a>
      <div id="log">
        ...
        <form id="login-form" class="form-horizontal" action="<?php echo site_url('home/process_login');?>" method="POST">
          <div class="row-fluid">
            ...
            <div class="control-group">
              <div class="controls-row">
				...
				<?php if(isset($message_error) && $message_error){
					echo '<font color = "red">Tolong periksa username dan password Anda lagi</font>';
				}
				?>
				<!-- End .control-group -->
            <div class="form-actions full">
              <?php echo anchor('home/reset_password','Lupa Password ?')?>
