											...
											<div class='span8'>
														<div class='widget'>
															...
															<div class='widget-content'>
																<form  action='<?php echo site_url("con_jadwal/validate_tambahdatamanual")?>' method='post' id='formjadwal' class='form-horizontal'>
																	<input type="hidden" id="url" name="url" value="<?php echo site_url('con_jadwal/get_semester')?>">
																	<input type="hidden" id="url_a" name="url_a" value="<?php echo site_url('con_jadwal/get_all_pengampu')?>">
																	<?php $temp=$this->session->userdata('auto_date');if(!$temp):?>
																	<div class='control-group'>
																		<label class='control-label' for='thn_ajar'>Tahun Ajaran </label>
																		<div class='controls controls-row'>
																			<div class='span4'>   
																				<?php echo form_dropdown('thn_ajar', $dropdownYear,$inp['thn_ajar'],'class="select2" id="thn_ajar" name="thn_ajar"');?>
																			</div>
																			<div id='cek_thn_ajar'>
																		...
																		<div class='controls controls-row'>
																			<div class='span3'>
																				<select name='hari' id='hari' class='select2' style='width:100%;' required>
																					<option></option>
																					<option value='1' <?php if($inp['hari']==1){echo 'selected';}?>>Senin</option>
																					<option value='2' <?php if($inp['hari']==2){echo 'selected';}?>>Selasa</option>
																					<option value='3' <?php if($inp['hari']==3){echo 'selected';}?>>Rabu</option>
																					<option value='4' <?php if($inp['hari']==4){echo 'selected';}?>>Kamis</option>
																					<option value='5' <?php if($inp['hari']==5){echo 'selected';}?>>Jumat</option>
																				</select>
																			</div>
																		</div>
																	</div>
												...
												<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-hover" id="dataTable">
													...
													<tbody>
														...
														<tr>
															...
															<td> 
																<?php echo anchor('jadwal/edit/'.$q[$i]['id_jadwal'],'Edit','class="btn btn-primary btn-mini i-pencil"');?> 
