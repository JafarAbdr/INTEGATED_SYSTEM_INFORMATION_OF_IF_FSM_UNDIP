...
<div class="logo">
    <h4><a>Employee <strong>Informatika</strong></a></h4>
</div>
<nav id="sidebar" class="sidebar nav-collapse collapse">
    <ul id="side-nav" class="side-nav">
        ...
        <li class="accordion-group">
            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#side-nav" href="#forms-collapse"><i class="icon-plus"></i> <span class="name">Change</span></a>
            <ul id="forms-collapse" class="accordion-body collapse">
                <li  style='cursor : pointer;'  onclick='showPage("mem");'><a>Profile's</a></li>
            </ul>
        </li>
    </ul>
</nav>
        ...
        <div class="navbar">
            <div class="navbar-inner">
                <ul class="nav pull-right">
                    ...
                    <li class="hidden-phone"><a href="#" id="tryLogOut"><i class="icon-signout"></i></a></li>
                </ul>
...
<script src="resources/mystyle/js/Employee/employeearea.js"></script>
