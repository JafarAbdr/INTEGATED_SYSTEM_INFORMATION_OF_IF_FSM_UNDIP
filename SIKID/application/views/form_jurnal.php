	...
	echo form_open('c_dosen/add_data', $attributes);?>
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea name="nama_jurnal" class="autosize-transition span8"></textarea>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="nomor_volume"/>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<label>
						<input name="kategori" type="radio" id="jurnal1" value="Internasional" />
						<span class="lbl">Internasional</span>
					</label>

					<label>
						<input name="kategori" type="radio" id="jurnal2" value="Nasional Terakreditasi" />
						<span class="lbl">Nasional Terakreditasi</span>
					</label>

					<label>
						<input name="kategori" type="radio" id="jurnal3" value="Nasional Tidak Terakreditasi" />
			...
			<div class="control-group">
				...
				<div class="controls">
					<table class="table-common">
					  <tr="item">
					  	<td><input id="form2" type="text" class="auto" name="anggota[]" ></td><td></td>
					  </tr>
					</table>
