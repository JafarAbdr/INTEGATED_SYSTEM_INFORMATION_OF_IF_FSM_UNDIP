...
?>
	<!--<input type="button" value="EXPORT EXCEL" class="btn btn-mini btn-success" onclick="window.location.href='<?php echo site_url('c_excel1/export/'.$_POST['tahun'])?>'">-->
<?php }?>
			...
			for ($i=0;  $i<$jumlah; $i++){
				...
				$dtl=$dtl+1;
					...
					echo "<tr>
						 ...
						 <a class='btn btn-minier  btn-info' href='".site_url('c_admin/detail/'.$data['idjurnal'])."'>Detail</a>
						 
						 <a class='btn btn-minier  btn-warning' href='".site_url('c_admin/update/'.$data['idjurnal'])."'>Update</a>
						 
						 <a class='btn btn-minier  btn-danger' href='".site_url('c_admin/delete_jurnal/'.$data['idjurnal'])."'  onClick=\"return confirm('Apakah Anda Yakin Akan Menghapus Data ini?')\">Delete</a>
