<h4>AK JURNAL SEMESTER GANJIL</h4>
...
<tbody>
			...
			for ($i=0;  $i<$jumlah; $i++){
				...
				echo "<td>";	 
						...
						$tbl = $this->m_report->get_Jurnal_by_NIP_semester1($data['nip']);
						$tb = $this->m_ak->get_ak_jurnal();
						//print_r($tbl);
						$judul = "";
						$status = "";
						$nilai = 0;
						...
						$tbl2 = $this->m_report->get_Jurnal2_by_NIP_semester1($data['nip']);
						//anggota
...
<h4>AK JURNAL SEMESTER GENAP</h4>
<table class="table table-striped table-bordered example">
<!--<a class='btn btn-minier  btn-info').'>Export to Excel</a>
<input type="button" value="EXPORT EXCEL" class="btn btn-minier  btn-info" onclick="window.location.href='<?php echo site_url('c_excel1/export')?>'">
-->
...
<tbody>
			...
			for ($i=0;  $i<$jumlah; $i++){
				...
				echo "<td>";	 
						...
						$tbl = $this->m_report->get_Jurnal_by_NIP_semester2($data['nip']);
						$tb = $this->m_ak->get_ak_jurnal();
						//print_r($tbl);
						$judul = "";
						$status = "";
						...
						$tbl2 = $this->m_report->get_Jurnal2_by_NIP_semester2($data['nip']);
						//anggota
						$anggota=explode("//",'anggota');
						//for($i=0;$i<count($anggota);$i++){
							//$pecah[$i]=explode('--',$anggota[$i]);
