...
class C_Jurusan extends CI_Controller {
	...
	function view_upload(){
		...
		$this->data['page'] = 'level2/data_upload'; //tak ganti
	...
	function ak_jurnal(){
		...
		$this->data['page'] = 'level3/ak_jurnal_semester';
		$this->data['query']= $this->m_user->get_dosen();
		$this->load->view('level3/template_jurusan', $this->data);
	}
	...
	function ak_prosiding(){
		...
		//$this->data['page'] = 'level3/ak_prosiding'; //nanti ditambah
		$this->data['page'] = 'level3/ak_prosiding_semester';
		$this->data['query']= $this->m_user->get_dosen();
		$this->load->view('level3/template_jurusan', $this->data);
	}
	...
	function ubah_ak_jurnal(){
	  ...
	  $this->data['page'] = 'level3/form_ubah_ak_jurnal';
	 $this->load->view('level3/template_jurusan', $this->data);
	}
