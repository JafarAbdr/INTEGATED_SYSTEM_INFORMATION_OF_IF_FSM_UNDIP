				...
				<ul class="nav nav-list">
					...
					<li>
						<a href="#" class="dropdown-toggle">
							...
							<ul class="submenu">	
							   <li>
							     <a href="<?php echo site_url('c_admin/add_penelitian')?>">
							   ...
							   <li>
								 <a href="<?php echo site_url('c_admin/add_pengabdian')?>">
								   <i class="icon-double-angle-right"></i>
								   Pengabdian
							     </a>
							   </li>
					...
					<li>
						<a href="<?php echo site_url('c_admin/view_penelitian')?>">
							<i class="icon-book"></i>
					...
					<li>
						<a href="<?php echo site_url('c_admin/view_pengabdian')?>">
