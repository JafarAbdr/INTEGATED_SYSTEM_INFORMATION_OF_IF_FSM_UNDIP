...
<script type="text/javascript"> 
	...
	<?php $attributes = array('class' => 'form-horizontal');
			echo form_open('c_admin/edit_data/'.$data['idpenelitian'], $attributes);
	?>
			
			<div class="control-group">
				<label class="control-label" for="judul">Judul</label>
				<div class="controls">
					<input type="text" name="judul" class="span9"placeholder="Judul Penelitian" value="<?php echo "$data[judul]"?>"/>
				</div>
			</div>
