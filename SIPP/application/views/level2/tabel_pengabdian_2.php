			...
			for ($i=0;  $i<$jumlah; $i++){
				...
				$jml=$jml+$data['alokasi_dana'];
					echo "<tr>
						 ...
						 <a class='btn btn-minier  btn-info' href='".site_url('c_admin/detail_pengabdian/'.$data['idpengabdian'])."'>Detail</a>
						 
						 <a class='btn btn-minier  btn-warning' href='".site_url('c_admin/update_pengabdian/'.$data['idpengabdian'])."'>Update</a>
						 
						 <a class='btn btn-minier  btn-danger' href='".site_url('c_admin/delete_pengabdian/'.$data['idpengabdian'])."'  onClick=\"return confirm('Apakah Anda Yakin Akan Menghapus Data ini?')\">Delete</a>
