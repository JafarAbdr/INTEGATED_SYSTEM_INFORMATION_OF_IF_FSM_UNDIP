	...
	echo form_open('c_dosen/add_pengabdian', $attributes);?>
			
			<div class="control-group">
				<label class="control-label" for="judul">Judul</label>
				<div class="controls">
					<textarea name="judul" class="autosize-transition span8"></textarea>*harus diisi
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="tahun"/>*harus diisi
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="ketua[]" class="auto"/>*harus diisi
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<table class="table-common">
					  <tr id="item"><td><input type="text" class="auto" name="anggota[]"></td><td>*harus diisi</td>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="dana" placeholder="contoh: 1000000" />*harus diisi
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="tempat"/>*harus diisi
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="row-fluid input-append">
					<input class="date-picker" name="tgl_k" type="text" data-date-format="dd-mm-yyyy" id="form2" disabled/>
					<span class="add-on">
			...
			<div class="control-group">
				...
				<div class="controls">
				<div class="row-fluid input-append">
					<input id="form3" class="date-picker" name="bts_k" type="text"  data-date-format="dd-mm-yyyy" disabled/>
					<span class="add-on">
						<i class="icon-calendar"></i>
					</span>
				</div>
