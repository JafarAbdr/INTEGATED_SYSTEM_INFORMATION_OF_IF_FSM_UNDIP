				...
				<ul class="nav nav-list">
					...
					<li>
						<a href="#" class="dropdown-toggle">
							...
							<ul class="submenu">
								   <a href="<?php echo site_url('c_dosen/penelitian/')?>">
							   <li>
							   ...
							   <li>
								   <a href="<?php echo site_url('c_dosen/pengabdian')?>">
										   <i class="icon-double-angle-right"></i>
										   Pengabdian
								   </a>
							   </li>
					...
					<li>
						<a href="<?php echo site_url('c_dosen/view_penelitian')?>">
							<i class="icon-book"></i>
					...
					<li>
						<a href="<?php echo site_url('c_dosen/view_pengabdian')?>">
